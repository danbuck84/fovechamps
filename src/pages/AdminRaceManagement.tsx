...
const AdminRaceManagement = () => {
  ...
  if (isLoading) {
    return (
      <div className="p-8 text-center text-racing-silver">Carregando...</div>
    );
  }

  return (
    <div className="p-4 md:p-6">
      <h1 className="text-2xl md:text-3xl font-bold text-racing-white mb-6">Gerenciamento de Corridas</h1>

      ...
      <div className="min-h-screen bg-racing-black p-6">
        <div className="max-w-3xl mx-auto">
          ...
          <Card className="bg-racing-black border-racing-silver/20">
            <CardHeader>
              <CardTitle className="text-2xl text-racing-white">{team.name}</CardTitle>
            </CardHeader>
            <CardContent className="space-y-6">
              <div>
                <h3 className="text-lg font-medium text-racing-white mb-2">Informações da Equipe</h3>
                <p className="text-racing-silver">Motor: <span className="text-racing-white">{team.engine}</span></p>
              </div>
              
              <div>
                <h3 className="text-lg font-medium text-racing-white mb-2">Pilotos</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {team.drivers?.map((driver) => (
                    ...
                    >
                      ...
                      <CardContent>
                        <p className="text-racing-silver">Número: {driver.number}</p>
                      </CardContent>
                    </Card>
                  ))}
                </div>
